...
single-group and multiple-group proof-of-concept path, plus single-group
multiple imputation; multiple-group multiple-imputation and Mplus validation
workflows for mixed indicators still need follow-up testing.
